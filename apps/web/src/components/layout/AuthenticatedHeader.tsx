...
export function AuthenticatedHeader({ userName, userRole = 'student' }: AuthenticatedHeaderProps) {
  ...
  const navLinks = [
    ...
    { href: '/billing', label: 'Billing', show: true },
    { href: '/teacher/dashboard', label: 'Teacher', show: userRole === 'teacher' || userRole === 'admin' },
  ];
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" size="sm" className="gap-2">
                ...
                {userName && <span className="hidden sm:inline">{userName.split(' ')[0]}</span>}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
